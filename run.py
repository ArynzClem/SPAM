# [+]-------------------------------------------[+]
#  | Creator : AryznClem   		         |
#  | Github : https://github.com/ArynzClem       |
#  | Powered By MUSLIM CYBER ARMY		 |
# [+]-------------------------------------------[+]
# Install Modules
...
def banner():
    ...
    autoketik (f"""
     ...
     \033[1;0m──────────────────────────┬─────────────────────────
  \033[1;0m┌────────────────────────────┼───────────────────────────┐
  {W}│ Creator{R}:{W}ArynzClem          │ Version {R}:{G} 3.0{W}             │
  {W}│ Github{R}:{G}github.com/ArynzClem{W}│ {W}Your Ip {R}:{Y} {ip}{W}  │
  {W}│ Team{R}:{W}Executed {biru}Team MCA{W}     │ Perfect Brutal {biru}Sms Tools  {W}│
  └────────────────────────────┼───────────────────────────┘""")
...
def start(): # Def Untuk Start Tools
    ...
    if pil == "2":
        ...
        tanya()
    if pil == "3":
        os.system("xdg-open https://github.com/ArynzClem")
...
# Copyright 08/07/22
# Made By Executed Team ❤️ With ArynzClem
